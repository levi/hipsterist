...
<head profile="http://gmpg.org/xfn/11">
	...
	<!--[if lt IE 8]>
	<script src="http://hipsterist.com/wp-content/themes/hipsterist/ie.js" type="text/javascript"></script>
	<![endif]-->
	
	<link rel="stylesheet" href="<?php bloginfo('stylesheet_url'); ?>" type="text/css" media="screen" />
	<?php if ($color): ?>
	<link rel="stylesheet" href="<?php bloginfo('template_url'); ?>/<?php echo $color; ?>.css" type="text/css" media="screen" />
	<?php endif ?>
